#ifndef MJM_MARC_XML_H__
#define MJM_MARC_XML_H__
...
// generated by /home/documents/cpp/scripts/cpputil -classhdr mjm_marc_xml   
//g++  -Wall -std=gnu++11 -DTEST_MJM_MARC_XML -I. -I../../mjm/hlib -I../../mjm/num  -I /usr/include/libxml2  -gdwarf-3 -O0  -x c++ mjm_marc_xml.h  -lpthread -lreadline -lxml2 -Wno-unused-variable -Wno-unused-function
// g++  -Wall -std=gnu++11 -DTEST_MJM_MARC_XML -I. -I../../mjm/hlib -I../../mjm/num  -I /usr/include/libxml2  -gdwarf-3 -O0  -x c++ mjm_marc_xml.h  -lpthread -lreadline -lxml2
// g++  -Wall -std=gnu++11 -DTEST_MJM_MARC_XML -I. -I../../mjm/hlib -I../../mjm/num  -gdwarf-3 -O0  -x c++ mjm_marc_xml.h  -lpthread -lreadline
...
StrTy marc_xform( const StrTy & fn, const IdxTy  flags) const
{
Ragged r;
...
1 html 3 body 4 collection 7 record 22 controlfield 23 tag 24 text = 007
1 html 3 body 4 collection 7 record 22 controlfield 25 text = cr  n ---ma mp
1 html 3 body 4 collection 7 record 26 controlfield 27 tag 28 text = 008
1 html 3 body 4 collection 7 record 26 controlfield 29 text = 110901s1954    xx a  
  ob    000 0 eng d
1 html 3 body 4 collection 7 record 30 datafield 31 tag 32 text = 024
1 html 3 body 4 collection 7 record 30 datafield 33 ind1 34 text = 7
1 html 3 body 4 collection 7 record 30 datafield 35 ind2 36 text =  
1 html 3 body 4 collection 7 record 30 datafield 37 subfield 38 code 39 text = a
1 html 3 body 4 collection 7 record 30 datafield 37 subfield 40 text = AA00004956_0
0001
1 html 3 body 4 collection 7 record 30 datafield 41 subfield 42 code 43 text = 2
1 html 3 body 4 collection 7 record 30 datafield 41 subfield 44 text = sobekcm
1 html 3 body 4 collection 7 record 45 datafield 46 tag 47 text = 035
1 html 3 body 4 collection 7 record 45 datafield 48 ind1 49 text = 9
1 html 3 body 4 collection 7 record 45 datafield 50 ind2 51 text =  
1 html 3 body 4 collection 7 record 45 datafield 52 subfield 53 code 54 text = a
1 html 3 body 4 collection 7 record 45 datafield 52 subfield 55 text = 024250310
1 html 3 body 4 collection 7 record 45 datafield 56 subfield 57 code 58 text = b
1 html 3 body 4 collection 7 record 45 datafield 56 subfield 59 text = UF
1 html 3 body 4 collection 7 record 60 datafield 61 tag 62 text = 035
1 html 3 body 4 collection 7 record 60 datafield 63 ind1 64 text = 9
1 html 3 body 4 collection 7 record 60 datafield 65 ind2 66 text =  
1 html 3 body 4 collection 7 record 60 datafield 67 subfield 68 code 69 text = a
1 html 3 body 4 collection 7 record 60 datafield 67 subfield 70 text = AEK7303
...
if ((m_parser_id=="") &&(l[idcol+1]=="datafield"))
{ m_parser_id=l[idcol]; }
else if (m_parser_id!=l[idcol]) break; //  return 0; 
const StrTy& f=l[len-off-4];
MM_ERR(" F "<<MMPR4(f,v,idcol,l[idcol+3]))
if (l[idcol+3]=="subfield") 
{
StrTy tid=l[idcol+2];
if ( sfid!=tid)
{
if (sfk!="") m_map[sfk]=sfv; 
sfid="";
sfk="";
sfv="";
} // sfid
...
//1 html 3 body 4 collection 7 record 45 datafield 56 subfield 59 text = UF
//1 html 3 body 4 collection 7 record 60 datafield 61 tag 62 text = 035
const IdxTy pcode=idcol+5;
if ((pcode<len)&&( l[pcode]=="code")) sfk=v; // pcode
else sfv=v;
MM_ERR("  "<<MMPR(v)<<MMPR4(sfv,sfk,l[pcode],sfid))
} // subfield
else if (f=="tag") m_tag=v;
else if (f=="ind1") m_ind1=v;
else if (f=="ind2") m_ind2=v;
else { MM_ERR(" wtf "<<MMPR(f)<<MMPR4(i,sz,v,m_parser_id)) }
++i;
} // i<sz
if (sfk!="") m_map[sfk]=sfv; 
return 0; 
...
{ 
Ss ss;
ss<<"DF0 "<<MMPR4(m_parser_id,m_tag,m_ind1,m_ind2)<<CRLF;
MM_LOOP(ii,m_map) { ss<<"DF! "<<MMPR3(m_parser_id,(*ii).first,(*ii).second)<<CRLF; } 
return ss.str(); 
} // Dump 
...
{ // this doesnt  see the  later in loop  
...
template <class Tr>
class mjm_marc_xml_map : public std::map<typename Tr::StrTy, mjm_marc_xml< Tr > >  
{
 typedef mjm_marc_xml_map Myt;
typedef typename std::map<typename Tr::StrTy, mjm_marc_xml< Tr> >   Super;
 typedef typename Tr::IdxTy IdxTy;
 typedef typename Tr::D D;
 typedef typename Tr::StrTy StrTy;
 typedef typename Tr::Ss Ss;
...
typedef tester_< mjm_marc_xml <Tr>  > tester;
...
{
Ss ss;
ss<<" MJM_MARC_XML "<<__DATE__<<" "<<__TIME__<<CRLF;
MM_ERR(ss.str())
