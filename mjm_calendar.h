...
// QUICKCOMPILE g++ -DTEST_CALENDAR__ -Wall  -std=gnu++11 -gdwarf-3 -I.. -I../../../mjm/hlib -Wno-misleading-indentation  -Wno-unused-variable -Wno-unused-function -Wno-sign-compare -Wno-non-template-friend -x c++ mjm_calendar.h -l readline
